...
- Linha ???  (sent_id = cic-rep-6-12-C, ID 19 TOKEN alter): head e deprel
- Linha ???  (sent_id = cic-rep-6-12-D, ID 3, 6, 8 TOKEN te): deprel
- Linha ???  (sent_id = cic-rep-6-12-E, ID 11 TOKEN multa): features, head e deprel
- Linha ???  (sent_id = cic-rep-6-12-E, ID 21 TOKEN effugeris): head (15?16?)
